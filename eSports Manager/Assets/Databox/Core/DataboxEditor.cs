...
namespace Databox.Ed
{
	...
	public class DataboxEditor {
		...
		public static string cloudAgreement = "Databox/doorfortyfour is not viable for any loss of data or damages to your data when using the cloud service." + "\n" +
		...
		static void DrawToolbar()
		{
			...
			using (new GUILayout.HorizontalScope("Box"))
			{
				...
				{
					#if UNITY_EDITOR
					EditorCoroutines.Execute(database.LoadDatabaseAsync());
					#else
